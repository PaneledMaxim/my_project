...
def zad_3():
    ...
    values = ["Максим", 25, "Ростов", "миллионер"]
...
def zad_5():
    ...
    print("Задание 3")
    words = ["rostov", "table", "cheese", "moscow", "student", "python", "donstu", "lection"]
    ...
    print("Задание 7")
    names = ["Максим", "Мария", "Петр", "Анна", "Максим", "Сергей", "Мария", "Ольга", "Максим", "Мария"]
    name_count = {}
    for name in names:
